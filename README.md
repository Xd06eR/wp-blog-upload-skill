...
- **Image upload** — point the agent at a folder of images (`--media-dir`) and it uploads them to the WP media library, appends them to the body in filename order, and sets the first as the featured image. It uploads existing files; it doesn't generate, edit, or resize them.
